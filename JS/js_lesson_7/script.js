...
catalodList.push(new Item('Lloyd', ['./img/Image1.png', './img/Image2.png', './img/Image3.png'], 'Make a BIG impression.', 950, 20));
catalodList.push(new Item('Djay', ['./img/Image2.png', './img/Image3.png', './img/Image4.png'], 'Has a removable, fabric robe', 170));
catalodList.push(new Item('Zein', ['./img/Image3.png', './img/Image4.png', './img/Image5.png'], 'Individual sets of building', 150));
catalodList.push(new Item('Kai', ['./img/Image4.png', './img/Image5.png', './img/Image6.png'], 'Components are dropped', 320, 10));
catalodList.push(new Item('Master Voo', ['./img/Image5.png', './img/Image6.png', './img/Image1.png'], 'Models carry brick-built', 220));
catalodList.push(new Item('Mech', ['./img/Image6.png', './img/Image1.png', './img/Image2.png'], 'The perfect building toys for kids', 220, 10));
